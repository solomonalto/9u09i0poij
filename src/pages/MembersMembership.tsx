      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-4">
            Become part of our thriving community and help us grow while unlocking exclusive benefits
          </p>
          <p className="text-gray-400">
            Your membership contribution directly supports the platform and enables us to deliver better experiences for everyone
          </p>
        </div>
          ...
          <div className="mb-12 p-6 bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-2xl max-w-3xl mx-auto">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-sm text-green-300 font-medium">Active Community Member</p>
                  <p className="text-lg font-semibold text-white">
                    {getTierConfig(currentMemberTier).displayName}
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 p-6 bg-white/5 border border-white/10 rounded-xl hover:border-white/20 transition-all">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Select a membership tier that matches your level of community involvement. Each tier unlocks unique benefits and perks.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-white/5 border border-white/10 rounded-xl hover:border-white/20 transition-all">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Pay securely through our trusted payment partners. Choose monthly or annual billing—annual billing saves you up to 17%.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-white/5 border border-white/10 rounded-xl hover:border-white/20 transition-all">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Unlock Community Benefits</h3>
                <p className="text-gray-400">
                  Instantly gain access to exclusive community features, member discussions, special events, and all the perks of your tier.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <h2 className="text-3xl font-bold text-white mb-10 text-center">Why Join Our Community?</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/5 border border-blue-500/30 rounded-xl text-center hover:border-blue-500/50 transition-all">
              ...
              <h3 className="text-white font-semibold mb-2">Active Community</h3>
              <p className="text-sm text-gray-400">Connect with thousands of engaged community members</p>
            </div>
            ...
            <div className="p-6 bg-gradient-to-br from-purple-500/10 to-purple-600/5 border border-purple-500/30 rounded-xl text-center hover:border-purple-500/50 transition-all">
              ...
              <h3 className="text-white font-semibold mb-2">Learning Hub</h3>
              <p className="text-sm text-gray-400">Access exclusive webinars, workshops, and resources</p>
            </div>
            ...
            <div className="p-6 bg-gradient-to-br from-emerald-500/10 to-emerald-600/5 border border-emerald-500/30 rounded-xl text-center hover:border-emerald-500/50 transition-all">
              ...
              <p className="text-sm text-gray-400">Get priority help from our dedicated support team</p>
            </div>
            ...
            <div className="p-6 bg-gradient-to-br from-rose-500/10 to-rose-600/5 border border-rose-500/30 rounded-xl text-center hover:border-rose-500/50 transition-all">
              ...
              <p className="text-sm text-gray-400">Enjoy discounts, early access, and special rewards</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <details className="group border border-white/10 rounded-lg p-6 bg-white/5 hover:bg-white/10 transition-all cursor-pointer">
              ...
              <p className="text-gray-300 mt-4">
                Your membership directly supports our platform operations, community features, content creation tools, and team efforts to deliver an excellent experience for all members.
              </p>
            </details>
          </div>
        </div>
