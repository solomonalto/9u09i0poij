...
export class PaymentOrchestration {
  ...
  private static async validatePaymentRequest(
    ...
    const creatorTierOrder = { free: 0, premium: 1, professional: 2, elite: 3 };
    const memberTierOrder = { welcome: 1, premium: 2, elite: 3, enterprise: 4 };
    ...
    const currentTierOrder = tierOrder[request.currentTier];
    const targetTierOrder = tierOrder[request.targetTier];
